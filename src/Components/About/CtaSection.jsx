  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center justify-center text-center text-white px-4 sm:px-6 py-8 sm:py-12 md:py-20 gap-4 max-w-3xl mx-auto">
        <h2
          className="text-xl sm:text-2xl md:text-4xl font-semibold leading-snug italic"
          data-aos="fade-down"
        >
          Partner with DKM Group for reliable
          <span
            className="block text-xl sm:text-2xl md:text-4xl font-semibold leading-snug italic mt-1"
            data-aos="fade-up"
            data-aos-delay="200"
          >
